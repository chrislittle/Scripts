...
param alertDescription string = 'Virtual Hub BGP Peer Status - Alert when BGP peer is down'

@description('Array of Azure resource Ids. For example - /subscriptions/00000000-0000-0000-0000-0000-00000000/resourceGroup/resource-group-name/Microsoft.Network/virtualHubs/hub-name')
@minLength(1)
  ...
  properties: {
    ...
    criteria: {
      ...
      allOf: [
        {
          name: '1st criterion'
          metricName: 'BgpConnectivityStatus'
