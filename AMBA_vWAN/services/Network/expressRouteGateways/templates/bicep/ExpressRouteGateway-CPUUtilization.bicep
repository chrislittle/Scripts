...
param alertDescription string = 'ExpressRoute Gateway CPU Utilization - Alert when CPU utilization is high'
...
@description('Threshold value associated with a metric trigger - 80% CPU utilization')
  ...
  properties: {
    ...
    criteria: {
      ...
      allOf: [
        {
          name: '1st criterion'
          metricName: 'ErGatewayCpuUtilization'
