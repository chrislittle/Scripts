...
param alertDescription string = 'ExpressRoute Gateway Connection Bits Out Per Second - Monitoring egress bandwidth from Azure via ExpressRoute Gateway. Uses real gateway scale unit detection for accurate thresholds.'
